...
// Hero Section image
import headerImg from "../Images/icons/header-img.svg";
...
function Home() {
  ...
  const toRotate = ["Tech Enthusiast", "Data Scientist", "Front-End Web Developer", "Back-End Web Developer", "Cyber Security Enthusiast"];
